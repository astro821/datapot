...
export function IconPot(p: IconProps) {
  return (
    <Svg {...p}>
      <path
        d="M7 10h10l-1 9H8l-1-9Zm2-3V6a3 3 0 0 1 6 0v1"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
...
export function IconUsers(p: IconProps) {
  return (
    <Svg {...p}>
      <path
        d="M16 19v-1a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v1M9.5 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm11.5 8v-1a4 4 0 0 0-3-3.87M15 4.13a3 3 0 0 1 0 5.74"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function IconManage(p: IconProps) {
  return (
    <Svg {...p}>
      <path
...
export function IconOpenApi(p: IconProps) {
  return (
    <Svg {...p}>
      <path
